                  ...
                  <div className="flex items-center">
                    {[0, 1, 2, 3, 4].map((i) => (
                      <StarIcon
                        ...
                        aria-hidden="true"
                        className={classNames(
                          (rating.average ?? 0) > i ? 'text-yellow-400' : 'text-gray-300 dark:text-gray-600',
                          'h-5 w-5 shrink-0'
                        )}
                      />
                    ))}
                  </div>
                  <p className="sr-only">{rating.average?.toFixed(1) ?? 0} de 5 estrelas</p>
            ...
            <div className="mt-6">
              <div className="flex items-center">
                <span className="text-lg font-medium text-gray-900 dark:text-gray-100">
                  Estoque: {product.inventory > 0 ? product.inventory : 'Indisponível'}
                </span>
                <span className="ml-3">
                  {product.inventory > 0 ? (
